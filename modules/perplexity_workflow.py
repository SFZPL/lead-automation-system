...
class PerplexityWorkflow:
    ...
    def _build_comprehensive_prompt(self, leads: List[Dict[str, Any]]) -> str:
        ...
        prompt_parts.extend([
            ...
            "",
            "**LINKEDIN PROFILE SEARCH - MULTI-ATTEMPT STRATEGY (TRY ALL):**",
            "Finding LinkedIn profiles is CRITICAL. You MUST try MULTIPLE search variations until you find the profile:",
            "",
            "1. **Primary Search:** '[Full Name] LinkedIn' (e.g., 'Sanad Zaqtan LinkedIn')",
            "2. **With Location:** '[Full Name] LinkedIn [Country]' (e.g., 'Sanad Zaqtan LinkedIn UAE')",
            "3. **With City:** '[Full Name] LinkedIn [City]' (e.g., 'Sanad Zaqtan LinkedIn Abu Dhabi')",
            "4. **With Company:** '[Full Name] LinkedIn [Company]' (e.g., 'Sanad Zaqtan LinkedIn Prezlab')",
            "5. **Name Variations:**",
            "   - First name only + LinkedIn: '[FirstName] [LastName] LinkedIn' → 'Sanad Zaqtan LinkedIn'",
            "   - Reverse order: '[LastName] [FirstName] LinkedIn' → 'Zaqtan Sanad LinkedIn'",
            "   - Without middle names: If 3+ names, try '[FirstName] [LastName] LinkedIn'",
            "   - Common nicknames: John → Johnny, Robert → Rob, Mohammad → Mohammed/Mohamed",
            "6. **Google Advanced Search:** Use 'site:linkedin.com/in/ [Name]' to search directly on LinkedIn domain",
            "7. **With Title/Role:** '[Full Name] [Job Title] LinkedIn' (if you have job title from email signature)",
            "8. **Email Username Search:** '[email username] LinkedIn' (e.g., if email is sanad.zaqtan@company.com, try 'sanad.zaqtan LinkedIn')",
            "",
            "**DO NOT give up until you've tried at least 5-7 different search variations!**",
            "- For foreign names, try transliterations and cultural variations (e.g., Mohammed/Muhammad/Mohamed)",
            "- If initial searches fail, try broader searches then narrow down by company/location",
            "- Check LinkedIn's 'People also viewed' suggestions from similar profiles",
            ...
            "",
            "**CRITICAL REMINDERS:**",
            "- LinkedIn is your PRIMARY source - exhaust ALL search variations before moving on",
            "- The topmost position in LinkedIn Experience = current role",
            "- List ALL other concurrent positions in the Notes field",
            "- If you cannot find a LinkedIn profile after trying 7+ variations, note in Notes: 'LinkedIn profile not found after extensive search attempts'",
            "",
